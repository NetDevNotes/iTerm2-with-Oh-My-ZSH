...
* [Configuration File](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#configuration-file-zsh)
* [Themes](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#themes-zsh)
* [Split Panes](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#split-panes-iterm)
* [Autocomplete](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#autocomplete-iterm--zsh)
* [Tab completion for cd](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#tab-completion-for-cd-zsh)
* [Shared command history](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#shared-command-history-zsh)
* [Fixing case](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#fixing-case-zsh)
* [Find a switch](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#find-a-switch-zsh)
...
* [Enable multiple plugins](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#enable-multiple-plugins-zsh)
* [Spotify (OSX plugin)](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#spotify-zsh-osx-plugin)
* [Ansible](https://github.com/NetDevNotes/iTerm2-with-Oh-My-ZSH/blob/master/README.md#ansible-zsh)
...
So as you can imagine from listing just a few of the features iTerm2 and Oh-My-ZSH offer, using both together is a powerful combination.
...
2. Enter your password when prompted & `oh-my-zsh ....is now installed!`
```
         __                                     __
